function setScreenAndMenu() {
    var e = $(window).height();
    $(".cover").css("height", e), $("#header").css("top", e - 100), setTimeout(function() {
        $("#header").css("display", "block")
    }, 100);
    var t = parseInt($("#header").css("top"));
    $(window).scroll(function() {
        var e = $(window).scrollTop();
        e > t ? $("#header").addClass("white") : $("#header").removeClass("white"), e > 0 && 270 > e && ($(".navButton").removeClass("active"), $(".navMobile").removeClass("active"))
    }), $(".navButton").click(function() {
        $(".navButton").hasClass("active") ? ($(".navButton").removeClass("active"), $(".navMobile").removeClass("active")) : ($(".navButton").addClass("active"), $(".navMobile").addClass("active"))
    }), $(".navList li a").click(function() {
        $(".navButton").removeClass("active"), $(".navMobile").removeClass("active")
    }), $(".navButton").click(function() {
        var e = $(window).scrollTop();
        270 > e && $(window).scrollTop(270)
    })
}! function(e, t) {
    ...
    var ut = function(e) {
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[B] || (t[B] = {}), (s = l[r]) && s[0] === P && s[1] === o) return u[2] = s[2];
        ...
        var x, w, T, E, C, k, S, N, A, j, D, L, H, _, q, F, O, R, M, B = "sizzle" + 1 * new Date,
            $ = e.document,
            P = 0,
            I = 0,
            W = n(),
        ...
        w = t.support = {}, C = t.isXML = function(e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, _ = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Et, !1) : n.attachEvent && n.attachEvent("onunload", Et)), q = !C(r), w.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = i(function(e) {
                return e.appendChild(r.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = vt.test(r.getElementsByClassName), w.getById = i(function(e) {
                return _.appendChild(e).id = B, !r.getElementsByName || !r.getElementsByName(B).length
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[B] || (g[B] = {}), u = c[e] || [], p = u[0] === P && u[1], f = u[0] === P && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
    ...
    Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), l = (Pt.exec(o) || ["", ""])[1].toLowerCase(), c = Yt[l] || Yt._default, s.innerHTML = c[1] + o.replace($t, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        html: function(e) {
            return jt(this, function(e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Mt.test(e) || !nt.leadingWhitespace && Bt.test(e) || Yt[(Pt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace($t, "<$1></$2>");
                    try {
    ...
    it.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(bt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Nn && Sn || !kn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(Sn ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Nn && Sn || !kn.test(n) ? e.setAttribute(!Sn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, it.each(it.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = Cn[t] || it.find.attr;
        Cn[t] = Nn && Sn || !kn.test(t) ? function(e, t, r) {
            var i, o;
    ...
    qn = In.exec(Fn.toLowerCase()) || [], it.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Fn) + "").replace(On, "").replace(Pn, qn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = In.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), $(Wn, d, t, w), 2 === b) return w;
...
function() {
    var e, t, n, r, i, o, a, s, l, u, c, d, f, p, h, m, g, v, y, b, x, w, T, E, C, k, S, N, A, j, D, L, H, _, q, F, O, R, M, B, $, P, I, W, z, X, U, V, G, Y, J, K, Q, Z, et, tt, nt = [].indexOf || function(e) {
        ...
        it = function(e, t) {
            ...
            for (var r in t) rt.call(t, r) && (e[r] = t[r]);
    ...
    _ = {}, f = 10, J = !1, M = null, y = null, L = null, $ = null, et = null, r = {
        ...
        var t;
        return e = new n(e), X(), d(), null != M && M.start(), J && (t = K(e.absolute)) ? (C(t), k(e, null, !1)) : k(e, G)
    }, K = function(e) {
        var t;
        ...
        return null == n && (n = !0), Q(r.FETCH, {
            url: e.absolute
        }), null != et && et.abort(), et = new XMLHttpRequest, et.open("GET", e.withoutHashForIE10compatibility(), !0), et.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"), et.setRequestHeader("X-XHR-Referer", $), et.onload = function() {
            var n;
            return Q(r.RECEIVE, {
                url: e.absolute
            }), (n = R()) ? (P(e), I(), p.apply(null, T(n)), H(), "function" == typeof t && t(), Q(r.LOAD)) : document.location.href = v() || e.absolute
        }, M && n && (et.onprogress = function() {
            return function(e) {
                var t;
        ...
        return null != et && et.abort(), p(e.title, e.body), B(e), Q(r.RESTORE)
    }, d = function() {
        var e;
        ...
        var t, n, i, o, a, s;
        for (i = Object.keys(_), t = i.map(function(e) {
                return _[e].cachedAt
            }).sort(function(e, t) {
                return t - e
            }), s = [], o = 0, a = i.length; a > o; o++) n = i[o], _[n].cachedAt <= t[e] && (Q(r.EXPIRE, _[n]), s.push(delete _[n]));
        return s
    }, p = function(t, n, i, o) {
        return Q(r.BEFORE_UNLOAD), document.title = t, document.documentElement.replaceChild(n, document.body), null != i && e.update(i), Y(), o && w(), y = window.history.state, null != M && M.done(), Q(r.CHANGE), Q(r.UPDATE)
    }, w = function() {
        ...
        return (e = new n(e)).absolute !== $ ? window.history.pushState({
            turbolinks: !0,
            url: e.absolute
        }, "", e.absolute) : void 0
    }, I = function() {
        ...
        return t = function() {
            ...
            var t, n, r, i, o;
            for (i = e.querySelector("head").childNodes, o = [], n = 0, r = i.length; r > n; n++) t = i[n], null != ("function" == typeof t.getAttribute ? t.getAttribute("data-turbolinks-track") : void 0) && o.push(t.getAttribute("src") || t.getAttribute("href"));
            return o
        }, e = function(e) {
            var t;
            ...
            var n, r, i, o, a;
            for (e.length > t.length && (o = [t, e], e = o[0], t = o[1]), a = [], r = 0, i = e.length; i > r; r++) n = e[r], nt.call(t, n) >= 0 && a.push(n);
            return a
        ...
        function e(e) {
            this.event = e, this.event.defaultPrevented || (this._extractLink(), this._validForTurbolinks() && (q(this.link.absolute) || Z(this.link.href), this.event.preventDefault()))
        }
        ...
        var t, r;
        return (null != (r = e.state) ? r.turbolinks : void 0) ? (t = _[new n(e.state.url).absolute]) ? (d(), C(t)) : Z(e.target.location.href) : void 0
    }, N = function() {
        return z(), W(), document.addEventListener("click", t.installHandlerLast, !0), window.addEventListener("hashchange", function() {
            return z(), W()
        }, !1), c(function() {
            return window.addEventListener("popstate", j, !1)
        })
    }, S = void 0 !== window.history.state || navigator.userAgent.match(/Firefox\/2[6|7]/), l = window.history && window.history.pushState && window.history.replaceState && S, a = !navigator.userAgent.match(/CriOS\//), V = "GET" === (tt = O("request_method")) || "" === tt, u = l && a && V, s = document.addEventListener && document.createEvent, s && (A(), D()), u ? (Z = E, N()) : Z = function(e) {
